        ...
        <div role="tabpanel" class="tab-pane active" id="service">             
            {!! Form::open(array('url' => 'admin/service_section','class'=>'form-horizontal padding-15','name'=>'service_form','id'=>'service_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="section_service_desc" value="{{ $sections->section_service_desc }}" class="form-control" value="">                         
                    </div>
                </div>
        ...
        <div role="tabpanel" class="tab-pane" id="team">
            ...
            {!! Form::open(array('url' => 'admin/team_section','class'=>'form-horizontal padding-15','name'=>'team_form','id'=>'team_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Section Sub Title</label>
                    <div class="col-sm-9">
                        <input type="text" name="section_team_desc" value="{{ $sections->section_team_desc }}" class="form-control" value="">                         
                    </div>
                </div> 
                  <hr>
                <div class="form-group">
        ...
        <div role="tabpanel" class="tab-pane" id="features">
            ...
            {!! Form::open(array('url' => 'admin/features_section','class'=>'form-horizontal padding-15','name'=>'features_form','id'=>'features_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Description</label>
                    <div class="col-sm-9">
                        <input type="text" name="section_features_desc" value="{{ $sections->section_features_desc }}" class="form-control" value="">                         
                    </div>
                </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="section_features1_icon" value="{{ $sections->section_features1_icon }}" class="form-control" value="" placeholder="smile-o">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="section_features2_icon" value="{{ $sections->section_features2_icon }}" class="form-control" value="" placeholder="smile-o">
                        <small class="text-muted bold"><a href="http://fontawesome.io/cheatsheet/" Target="_blank">Font Awesome Icon</a></small>
                    </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="section_features3_icon" value="{{ $sections->section_features3_icon }}" class="form-control" value="" placeholder="smile-o">
                        <small class="text-muted bold"><a href="http://fontawesome.io/cheatsheet/" Target="_blank">Font Awesome Icon</a></small>
                    </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="section_features4_icon" value="{{ $sections->section_features4_icon }}" class="form-control" value="" placeholder="smile-o">
                        <small class="text-muted bold"><a href="http://fontawesome.io/cheatsheet/" Target="_blank">Font Awesome Icon</a></small>
                    </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="section_features5_icon" value="{{ $sections->section_features5_icon }}" class="form-control" value="" placeholder="smile-o">
                        <small class="text-muted bold"><a href="http://fontawesome.io/cheatsheet/" Target="_blank">Font Awesome Icon</a></small>
                    </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="section_features6_icon" value="{{ $sections->section_features6_icon }}" class="form-control" value="" placeholder="smile-o">
                        <small class="text-muted bold"><a href="http://fontawesome.io/cheatsheet/" Target="_blank">Font Awesome Icon</a></small>
                    </div>
