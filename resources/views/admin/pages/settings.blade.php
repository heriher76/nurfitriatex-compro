...
<span aria-hidden="true">&times;</span></button>
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation">
            <a href="#email_settings" aria-controls="email_settings" role="tab" data-toggle="tab">SMTP Email Settings</a>
        </li>
    ...
    <div class="tab-content tab-content-default">
        ...
        <div role="tabpanel" class="tab-pane" id="email_settings">
            ...
            {!! Form::open(array('url' => 'admin/email_settings','class'=>'form-horizontal padding-15','name'=>'pass_form','id'=>'pass_form','role'=>'form')) !!}

                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Host</label>
                    <div class="col-sm-9">
                        <input type="text" name="smtp_host" value="{{env('MAIL_HOST')}}" class="form-control" placeholder="mail.example.com">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Port</label>
                    <div class="col-sm-9">
                        <input type="text" name="smtp_port" value="{{env('MAIL_PORT')}}" class="form-control"  placeholder="587">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Email</label>
                    <div class="col-sm-9">
                        <input type="text" name="smtp_email" value="{{env('MAIL_USERNAME')}}" class="form-control"  placeholder="info@example.com">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Password</label>
                    <div class="col-sm-9">
                        <input type="text" name="smtp_password" value="{{env('MAIL_PASSWORD')}}" class="form-control"  placeholder="">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="" class="col-sm-3 col-form-label">Encryption</label>
                      <div class="col-sm-9">
